...
function ShowRightMessage(indice){
  ...
  case 1:
    ...
    document.getElementById("Recordarme").innerHTML = `<button id="recordarme" class="text-center"><a href='https://amante.github.io/AgendateVPH.html' id='mylink'>Recordarme</a></button>`; 
    break;
   case 2:
    document.getElementById("SelectedVaccine").style.display = "block";
    document.getElementById("Messages").style.display = "block";
