...
function createMarker(place) {
  ...
  const place =
    ...
    for (let j = 0; j < place[i].length; j++) {
      switch (j) {
        case 0: nombre = place[i][j];
          break;
        case 1: direccion = place[i][j];
          break;
        case 2: region = place[i][j];
          break;
        case 3: ciudad = place[i][j];
          break;
        case 4: latitud = parseFloat(place[i][j]);
          break;
        case 5: longitud = parseFloat(place[i][j]);
          break;
      }
